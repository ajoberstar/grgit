...
`grgit.tag.list()`:: Returns a list of tags (link:http://ajoberstar.org/grgit/docs/groovydoc/org/ajoberstar/grgit/Tag.html[Tag]).
`grgit.tag.add(name: <name>, pointsTo: <commit>, force: <boolean>, annotate: <boolean>, message: <msg>, tagger: <person>)`:: Creates a new tag named `<name>` pointing at `<pointsTo>`. Returns the created link:http://ajoberstar.org/grgit/docs/groovydoc/org/ajoberstar/grgit/Tag.html[Tag].
...
tagger:: (`Person`, default `null`) Override the tagger recorded in the tag. This must be a link:http://ajoberstar.org/grgit/docs/groovydoc/org/ajoberstar/grgit/Person.html[Person].
